...
@WebServlet(
        ...
        loadOnStartup = 1,
        initParams = {
                @WebInitParam(name = "appId", value = "wx00a350a44a5061c8"),
                @WebInitParam(name = "appSecret", value = "dd72bcd3dc1f00f1d5a6c73cf037186b")
        })
public class AccessTokenServlet extends HttpServlet {
            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        System.out.println("AccessTokenServlet init:发生异常：" + e.getMessage());
                        e.printStackTrace();
                        try {
    ...
    private AccessToken getAccessToken(String appId, String appSecret) {
        ...
        System.out.println("AccessTokenServlet getAccessToken:获取到的access_token="+result);
